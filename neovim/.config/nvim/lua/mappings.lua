...
wk.add({
  ...
  -- Diagnostics
  {'[d', function() vim.diagnostic.jump({count=1, float=true}) end, desc = 'Diagnostics goto previous'},
  {']d', function() vim.diagnostic.jump({count=-1, float=true}) end, desc = 'Diagnostics goto next'},
