...
# Autoloaded functions, including the local zgenom extensions plugins.zsh declares. Set here rather
# than in plugins.zsh because compinit reads $fpath as it is when the zgenom save runs.
